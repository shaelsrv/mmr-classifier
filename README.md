# classifier — a Model Meets Reality starter
...
> Sort the observed cases into the model's classes and state, for each, what behaviour would show the sorting was wrong.

And when a claim comes due:

> Did any case sorted by this model behave like the other class?
...
python -m suites.new_model my-model --kind classifier \
